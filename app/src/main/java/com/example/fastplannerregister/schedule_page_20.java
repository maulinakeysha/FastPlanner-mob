...
public class schedule_page_20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_schedule_page20);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(schedule_page_20.this, schedule_page.class); // Ganti dengan nama activity yang sesuai
    ...
    private void startScheduleStart20Activity() {
        Intent intent = new Intent(schedule_page_20.this, schedule_start20.class);
    ...
    private void showTimePicker() {
        TimePickerDialog timePickerDialog = new TimePickerDialog(this, (view, hourOfDay, minute) -> {
            ...
            selectedEndDateTime.add(Calendar.HOUR_OF_DAY, 20);
            ...
            // Atur ulang handler untuk update setiap 20 jam
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    // Atur ulang handler untuk update selanjutnya setelah 20 jam
                    handler.postDelayed(this, 20 * 60 * 60 * 1000);
                }
            }, 20 * 60 * 60 * 1000); // Pertama kali dijalankan setelah 20 jam

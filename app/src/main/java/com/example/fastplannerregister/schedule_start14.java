...
public class schedule_start14 extends AppCompatActivity {
    ...
    private long durationInMillis = 14 * 60 * 60 * 1000; // 14 jam


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_schedule_start_14);
        Button backButton = findViewById(R.id.btn_back);
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(schedule_start14.this, schedule_page_14.class);

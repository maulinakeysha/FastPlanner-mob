...
public class schedule_start16 extends AppCompatActivity {
    ...
    private long durationInMillis = 16 * 60 * 60 * 1000; // 16 jam


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_schedule_start_16);
        Button backButton = findViewById(R.id.btn_back);
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(schedule_start16.this, schedule_page_16.class);
    ...
    private void showStopConfirmationDialog() {
        ...
        builder.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                // Mengirim data ke finish_16
                Intent intent = new Intent(schedule_start16.this, finish_16.class);
